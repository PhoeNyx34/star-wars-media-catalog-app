...
const NewMediaForm = ({ user }) => {
    ...
    const contributorsList = contributors.map(contributor => {
        return (<li>{contributor.contributorName}, {contributor.contributorRole}</li>)
    })
                ...
                <div className="cell large-5">
                    ...
                    <div className="choice-grid">
                        <fieldset className="grid-x">
                            <label className="cell large-5"><span className="required">*</span>Select one:</label>
                        ...
                        <fieldset className="grid-x">
                            <label className="cell large-5"><span className="required">*</span>Is this animated?</label>
                            <div className="cell large-3">
                                <label className="radio-choice">
                                    Yes
                        ...
                        <fieldset className="grid-x">
                            <label className="cell large-5">Is this Lego?</label>
                            <div className="cell large-3">
                                <label className="radio-choice">
                                    Yes
                ...
                <div className="cell large-7">
                    <fieldset className="grid-x">
                        ...
                        <div className="grid-x">
                            ...
                            <button className="button cell small-2" onClick={addContributor}>Add</button>
                        </div>
                    </fieldset>
                    <ul><em>Current contributors:</em>{contributorsList}</ul>
                </div>  
                <div className="cell large-12 grid-x form-buttons">
                    <input type="reset" value="Clear Form" className="button cell large-4" onClick={clearForm} />
                    <input type="submit" value="Submit Form" className="button cell large-4" />
                </div>              
            </form>
        </div>
    )
